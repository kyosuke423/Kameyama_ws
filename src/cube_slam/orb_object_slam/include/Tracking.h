...
#include <opencv2/imgcodecs/legacy/constants_c.h> //11.15new
#include <opencv2/imgproc/types_c.h> //11.15new
...
public:
    ...
    // void Getpointdata(const Eigen::MatrixXd &getpointdata_raw);
    // void Getyolodata(const Eigen::MatrixXd &getyolodata_raw);
