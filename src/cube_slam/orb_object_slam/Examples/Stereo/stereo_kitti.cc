...
int main(int argc, char **argv)
{
    ...
    for (int ni = 0; ni < nImages; ni++)
    {
        ...
        imLeft = cv::imread(vstrImageLeft[ni], cv::IMREAD_UNCHANGED); //11.24new CV_LOAD_IMAGE_UNCHANGEDをcv::IMREAD_UNCHANGEDに
        imRight = cv::imread(vstrImageRight[ni], cv::IMREAD_UNCHANGED); //11.24new CV_LOAD_IMAGE_UNCHANGEDをcv::IMREAD_UNCHANGEDに
