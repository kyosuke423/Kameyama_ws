...
set(MSG_I_FLAGS "-Itictoc_profiler:/home/dars/kameyama_ws/src/cube_slam/dependency/tictoc_profiler/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/dars/kameyama_ws/src/cube_slam/dependency/tictoc_profiler/msg/ProfilerEntry.msg" NAME_WE)
add_custom_target(_tictoc_profiler_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tictoc_profiler" "/home/dars/kameyama_ws/src/cube_slam/dependency/tictoc_profiler/msg/ProfilerEntry.msg" ""
)
...
_generate_msg_cpp(tictoc_profiler
  "/home/dars/kameyama_ws/src/cube_slam/dependency/tictoc_profiler/msg/ProfilerEntry.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tictoc_profiler)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tictoc_profiler\")")
  # install generated code
  install(
