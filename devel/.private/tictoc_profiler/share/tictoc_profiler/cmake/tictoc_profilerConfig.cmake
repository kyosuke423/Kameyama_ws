...
if("TRUE" STREQUAL "TRUE")
  set(tictoc_profiler_SOURCE_PREFIX /home/dars/kameyama_ws/src/cube_slam/dependency/tictoc_profiler)
  set(tictoc_profiler_DEVEL_PREFIX /home/dars/kameyama_ws/devel/.private/tictoc_profiler)
  ...
  set(tictoc_profiler_INSTALL_PREFIX /home/dars/kameyama_ws/install)
...
if(NOT "/home/dars/kameyama_ws/devel/.private/tictoc_profiler/include;/home/dars/kameyama_ws/src/cube_slam/dependency/tictoc_profiler/include;/usr/include " STREQUAL " ")
  set(tictoc_profiler_INCLUDE_DIRS "")
  set(_include_dirs "/home/dars/kameyama_ws/devel/.private/tictoc_profiler/include;/home/dars/kameyama_ws/src/cube_slam/dependency/tictoc_profiler/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tictoc_profiler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dars/kameyama_ws/src/cube_slam/dependency/tictoc_profiler/${idir}'.  ${_report}")
    endif()
    _list_append_unique(tictoc_profiler_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tictoc_profiler;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0;/usr/lib/x86_64-linux-gnu/libboost_chrono.so.1.71.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dars/kameyama_ws/devel/.private/tictoc_profiler/lib;/home/dars/kameyama_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(tictoc_profiler_EXPORTED_TARGETS ${${tictoc_profiler_dep}_EXPORTED_TARGETS})
endforeach()
