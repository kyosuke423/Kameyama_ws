...
if("TRUE" STREQUAL "TRUE")
  set(detect_3d_cuboid_SOURCE_PREFIX /home/dars/kameyama_ws/src/cube_slam/detect_3d_cuboid)
  set(detect_3d_cuboid_DEVEL_PREFIX /home/dars/kameyama_ws/devel/.private/detect_3d_cuboid)
  ...
  set(detect_3d_cuboid_INSTALL_PREFIX /home/dars/kameyama_ws/install)
...
if(NOT "/home/dars/kameyama_ws/src/cube_slam/detect_3d_cuboid/include " STREQUAL " ")
  set(detect_3d_cuboid_INCLUDE_DIRS "")
  set(_include_dirs "/home/dars/kameyama_ws/src/cube_slam/detect_3d_cuboid/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detect_3d_cuboid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dars/kameyama_ws/src/cube_slam/detect_3d_cuboid/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dars/kameyama_ws/devel/.private/detect_3d_cuboid/lib;/home/dars/kameyama_ws/devel/lib;/opt/ros/noetic/lib)
...
set(depends "cmake_modules;roscpp;roslib;tictoc_profiler;std_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(detect_3d_cuboid_EXPORTED_TARGETS ${${detect_3d_cuboid_dep}_EXPORTED_TARGETS})
endforeach()
