...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorial_python-srv:<multiplier-request> is deprecated: use tutorial_python-srv:multiplier-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<multiplier-request>)))
  ...
  "tutorial_python/multiplierRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'multiplier-request)))
  "Returns string type for a service object of type 'multiplier-request"
  "tutorial_python/multiplierRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorial_python-srv:<multiplier-response> is deprecated: use tutorial_python-srv:multiplier-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <multiplier-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_python-srv:result-val is deprecated.  Use tutorial_python-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<multiplier-response>)))
  ...
  "tutorial_python/multiplierResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'multiplier-response)))
  "Returns string type for a service object of type 'multiplier-response"
  "tutorial_python/multiplierResponse")
